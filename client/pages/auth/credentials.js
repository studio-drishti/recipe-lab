          ...
          <div className="row">
            <div className="col-sm-6 mr-auto ml-auto">
              <p>
                ...
                some other credentials based sign in method, you can define a
                signin() function in <strong>next-auth.functions.js</strong>.
                You can pass in any properties you need (e.g. username and
                password, a token, etc) to NextAuth.signin().
              </p>
              <div className="card mt-3 mb-3">
                <h4 className="card-header">Sign In</h4>
                <div className="card-body pb-0">
                  <p className="text-italic text-muted text-center">
                    Tip: Create an account first then try the password
                    "test1234".
                  </p>
                  <form
                    id="signin"
